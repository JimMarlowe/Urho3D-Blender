...
class AtomicSceneModel:
    ...
    def Load(self, uExportData, uModel, objectName):
        ...
        for uGeometry in uModel.geometries:
            uSceneMaterial = AtomicSceneMaterial()
...
def AtomicWriteMaterial(uScene, uMaterial, filepath, fOptions):
...
def AtomicWriteMaterialsList(uScene, uModel, filepath):

    # Search for the model in the AtomicScene
...
# Export scene and nodes
def AtomicExportScene(context, uScene, sOptions, fOptions):
